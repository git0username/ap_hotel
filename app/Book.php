...
class Book extends Model
{
    ...
    public function room()
    {
        ...
        // belongsToMany(相手テーブル(Room)のModelの指定、間接テーブル名、対応する間接テーブルの外部キー（一方の多（Book）のテーブルと対応するキー）、対応する間接テーブルの外部キー（もう一方の多（Room）のテーブルと対応するキー）)
        return $this->belongsToMany('App\Room','statements','roomtype','book_ID');
    }
